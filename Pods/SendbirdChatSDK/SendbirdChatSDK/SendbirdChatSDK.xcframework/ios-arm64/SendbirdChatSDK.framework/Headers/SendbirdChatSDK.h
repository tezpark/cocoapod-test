...
#if defined(__OBJC__)
@class SBDConversationListQueryParams;
@class SBDConversationListQuery;
@class AIAgentMessageTemplateListParams;
@class AIAgentMessageTemplateResult;
@class SBError;
@class AIAgentGroupChannelListQueryParams;
@class AIAgentGroupChannelListQuery;
@class AIAgentGroupChannelChangeLogsParams;
@class SBDGroupChannel;
@class NSString;
@class AIAgentGroupChannelUnreadMessageCountParams;
@class AIAgentUnreadMessageCount;

/// The <code>AIAgent</code> class provides an interface for interacting with AI agent within the Sendbird Chat SDK.
/// since:
/// 4.26.0
SWIFT_CLASS("_TtC15SendbirdChatSDK7AIAgent")
@interface AIAgent : NSObject
/// Creates a query for my conversation list.
/// since:
/// 4.29.0
/// \param params <code>ConversationListQueryParams</code>
///
///
/// returns:
/// GroupChannelListQuery instance for the current user.
+ (SBDConversationListQuery * _Nonnull)createConversationListQueryWithParams:(SBDConversationListQueryParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
/// Retrieves a list of AI agent message templates.
/// This method fetches the list of message templates associated with a specific AI Agent,
/// using the given parameters.
/// since:
/// 4.29.0
/// \param params An instance of <code>AIAgent.MessageTemplateListParams</code> that specifies
/// the filtering or pagination options for retrieving templates.
///
/// \param completionHandler A closure that receives the result of the template list
/// retrieval, delivered as an <code>AIAgent.MessageTemplatesResultHandler</code>.
///
+ (void)getAIAgentMessageTemplateListWithParams:(AIAgentMessageTemplateListParams * _Nonnull)params completionHandler:(void (^ _Nonnull)(AIAgentMessageTemplateResult * _Nullable, SBError * _Nullable))completionHandler;
/// Creates a query for AI Agent group channel list.
/// \param params Parameters for creating the AI Agent channel list query.
///
///
/// returns:
/// A new AIAgent.GroupChannelListQuery instance.
+ (AIAgentGroupChannelListQuery * _Nonnull)createChannelListQueryWithParams:(AIAgentGroupChannelListQueryParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
/// Retrieves change logs for AI Agent group channels using a timestamp.
/// since:
/// 4.29.0
/// \param timestamp The timestamp to start retrieving change logs from.
///
/// \param params Parameters for filtering the change logs.
///
/// \param completionHandler A closure that receives the change logs result.
///
+ (void)getMyGroupChannelChangeLogsWithTimestamp:(int64_t)timestamp params:(AIAgentGroupChannelChangeLogsParams * _Nonnull)params completionHandler:(void (^ _Nonnull)(NSArray<SBDGroupChannel *> * _Nullable, NSArray<NSString *> * _Nullable, BOOL, NSString * _Nullable, SBError * _Nullable))completionHandler;
/// Retrieves change logs for AI Agent group channels using a continuation token.
/// since:
/// 4.29.0
/// \param token The continuation token for pagination.
///
/// \param params Parameters for filtering the change logs.
///
/// \param completionHandler A closure that receives the change logs result.
///
+ (void)getMyGroupChannelChangeLogsWithToken:(NSString * _Nonnull)token params:(AIAgentGroupChannelChangeLogsParams * _Nonnull)params completionHandler:(void (^ _Nonnull)(NSArray<SBDGroupChannel *> * _Nullable, NSArray<NSString *> * _Nullable, BOOL, NSString * _Nullable, SBError * _Nullable))completionHandler;
/// Retrieves the unread message count for AI Agent group channels.
/// since:
/// 4.29.0
/// \param params Parameters for filtering unread message count.
///
/// \param completionHandler A closure that receives the unread message count result.
///
+ (void)getUnreadMessageCountWithParams:(AIAgentGroupChannelUnreadMessageCountParams * _Nonnull)params completionHandler:(void (^ _Nonnull)(AIAgentUnreadMessageCount * _Nullable, SBError * _Nullable))completionHandler;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


@interface AIAgent (SWIFT_EXTENSION(SendbirdChatSDK))
@end


/// Parameter class for updating AI agent context object
/// since:
/// 4.29.0
SWIFT_CLASS_NAMED("ContextObjectUpdateParams")
@interface SBDAIAgentContextObjectUpdateParams : NSObject
/// This string should follow the IETF BCP 47 format.
/// note:
/// For example, it might be “ko-KR” for Korean in South Korea or “en-US” for English in the United States.
/// seealso:
/// <a href="https://en.wikipedia.org/wiki/IETF_language_tag#List_of_common_primary_language_subtags">List of common primary language subtags</a>
@property (nonatomic, readonly, copy) NSString * _Nullable language;
/// This string should follow the ISO 3166 format.
/// note:
...
@property (nonatomic, readonly, copy) NSDictionary<NSString *, NSString *> * _Nonnull context;
/// Initializes the context object update parameters
/// \param language The language code following IETF BCP 47 format (optional)
///
/// \param country The country code following ISO 3166 format (optional)
///
/// \param context Additional context data as key-value pairs (defaults to empty dictionary)
///
- (nonnull instancetype)initWithLanguage:(NSString * _Nullable)language country:(NSString * _Nullable)country context:(NSDictionary<NSString *, NSString *> * _Nonnull)context OBJC_DESIGNATED_INITIALIZER;
...
enum SBDAIAgentChannelFilter : NSInteger;
@class ConversationStatusOptions;
enum SBDDeskChannelFilter : NSInteger;

SWIFT_CLASS_NAMED("GroupChannelListQuery")
@interface AIAgentGroupChannelListQuery : NSObject
...
@property (nonatomic, readonly) enum SBDAIAgentChannelFilter aiAgentChannelFilter;
@property (nonatomic, readonly, strong) ConversationStatusOptions * _Nonnull aiAgentConversationStatusFilter;
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nonnull aiAgentIds;
@property (nonatomic, readonly) enum SBDDeskChannelFilter deskChannelFilter;
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nonnull pinnedChannelURLs;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("Use `AIAgent.createGroupChannelListQuery(:)`");
...
/// Parameters for retrieving group channel change logs in AI Agent.
/// since:
/// 4.29.0
SWIFT_CLASS_NAMED("GroupChannelChangeLogsParams")
@interface AIAgentGroupChannelChangeLogsParams : NSObject
/// Filter option for AI Agent channels (include/exclude).
@property (nonatomic) enum SBDAIAgentChannelFilter aiAgentChannelFilter;
/// List of specific AI Agent IDs to filter by.
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull aiAgentIds;
/// Filter option for Desk channels (include/exclude).
@property (nonatomic) enum SBDDeskChannelFilter deskChannelFilter;
/// List of pinned channel URLs.
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull pinnedChannelURLs;
/// Default constructor.
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// Creates GroupChannelChangeLogsParams from an existing GroupChannelListQuery.
/// \param query The GroupChannelListQuery to copy parameters from.
///
///
/// returns:
/// A new <code>AIAgent.GroupChannelChangeLogsParams</code> instance with copied parameters.
+ (AIAgentGroupChannelChangeLogsParams * _Nonnull)createWithAIAgentGroupChannelListQuery:(AIAgentGroupChannelListQuery * _Nonnull)query SWIFT_WARN_UNUSED_RESULT;
@end
...
/// Parameters for retrieving unread message count in AI Agent group channels.
/// since:
/// 4.29.0
SWIFT_CLASS_NAMED("GroupChannelUnreadMessageCountParams")
@interface AIAgentGroupChannelUnreadMessageCountParams : NSObject
/// Filter option for AI Agent channels (include/exclude).
@property (nonatomic) enum SBDAIAgentChannelFilter aiAgentChannelFilter;
/// Filter options for AI Agent conversation status.
@property (nonatomic, strong) ConversationStatusOptions * _Nonnull aiAgentConversationStatusFilter;
/// List of specific AI Agent IDs to filter by.
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull aiAgentIds;
/// Filter option for Desk channels (include/exclude).
@property (nonatomic) enum SBDDeskChannelFilter deskChannelFilter;
...
@interface AIAgentInfo : NSObject
...
@interface AIAgentMessageTemplateListParams : NSObject
...
/// Set to <code>empty list</code> if don’t want to use template key filter.
...
- (nonnull instancetype)initWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(AIAgentMessageTemplateListParams * _Nonnull))builder OBJC_DESIGNATED_INITIALIZER;
@end
...
/// AIAgent message template result
/// since:
/// 4.26.0
SWIFT_CLASS_NAMED("MessageTemplateResult")
@interface AIAgentMessageTemplateResult : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// AI Agent Messenger setting parameter class
/// since:
/// 4.26.0
SWIFT_CLASS_NAMED("MessengerSettingsParams")
@interface SBDAIAgentMessengerSettingsParams : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull aiAgentId;
/// user id, the user will not behave normally in the normal group channel and will be marked as widget only.
...
@property (nonatomic, readonly, copy) NSString * _Nullable country;
@property (nonatomic, readonly, copy) NSDictionary<NSString *, NSString *> * _Nonnull context;
/// Cached active channel URL to reuse if possible.
/// since:
/// 4.27.0
@property (nonatomic, readonly, copy) NSString * _Nullable knownActiveChannelURL;
/// initializer for auto parameter
- (nonnull instancetype)initWithAiAgentId:(NSString * _Nonnull)aiAgentId userId:(NSString * _Nullable)userId language:(NSString * _Nullable)language country:(NSString * _Nullable)country context:(NSDictionary<NSString *, NSString *> * _Nonnull)context knownActiveChannelURL:(NSString * _Nullable)knownActiveChannelURL OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@class AIAgentPinnedChannelUnreadMessageCount;

/// Represents the unread message count information for AI Agent channels
SWIFT_CLASS_NAMED("UnreadMessageCount")
@interface AIAgentUnreadMessageCount : NSObject
/// Total number of unread messages across all channels
@property (nonatomic, readonly) NSUInteger total;
/// Number of unread messages in AI Agent channels
@property (nonatomic, readonly) NSUInteger aiAgentChannelCount;
/// Number of unread messages in desk channels
@property (nonatomic, readonly) NSUInteger deskChannelCount;
/// Array of unread message counts for pinned channels
@property (nonatomic, readonly, copy) NSArray<AIAgentPinnedChannelUnreadMessageCount *> * _Nonnull pinnedChannels;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// Represents the unread message count information for a specific pinned channel
SWIFT_CLASS_NAMED("PinnedChannelUnreadMessageCount")
@interface AIAgentPinnedChannelUnreadMessageCount : NSObject
...
/// Parameters for creating AI Agent group channel list queries.
/// since:
/// 4.29.0
SWIFT_CLASS_NAMED("GroupChannelListQueryParams")
@interface AIAgentGroupChannelListQueryParams : NSObject
/// Maximum number of channels to retrieve per request.
...
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull pinnedChannelURLs;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// Creates a GroupChannelListQueryParams with a builder pattern.
/// \param builder A closure that configures the parameters.
///
- (nonnull instancetype)initWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(AIAgentGroupChannelListQueryParams * _Nonnull))builder OBJC_DESIGNATED_INITIALIZER;
@end


/// since:
/// 4.27.0
typedef SWIFT_ENUM_NAMED(NSInteger, SBDAIAgentChannelFilter, "AIAgentChannelFilter", open) {
  SBDAIAgentChannelFilterExclude = 0,
  SBDAIAgentChannelFilterInclude = 1,
};
...
/// since:
/// 4.18.0
@property (nonatomic, readonly) int64_t notificationEventDeadline;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
typedef SWIFT_ENUM(NSInteger, ApiRequestType, closed) {
  ApiRequestTypeInternal = 0,
  ApiRequestTypeExternal = 1,
};
...
/// since:
/// 4.26.0
@property (nonatomic, strong) AIAgentInfo * _Nonnull aiAgentInfo;
...
/// The type of the token used in the authentication.
/// since:
/// 4.24.3
typedef SWIFT_ENUM_NAMED(NSInteger, SBDAuthTokenType, "AuthTokenType", open) {
  SBDAuthTokenTypeAccessToken = 1,
  SBDAuthTokenTypeSessionToken = 2,
};
...
- (SBDFileMessage * _Nullable)sendFileMessageWithParams:(SBDFileMessageCreateParams * _Nonnull)params originalMessage:(SBDFileMessage * _Nonnull)originalMessage completionHandler:(void (^ _Nullable)(SBDFileMessage * _Nullable, SBError * _Nullable))completionHandler;
...
/// note:
/// When using the moderation feature in ephemeral open channel, you should use this function that uses the <code>message</code> object, not the function that uses the <code>messageId</code>.
...
/// \param completionHandler The handler block to execute.
///
- (void)reportUser:(SBDUser * _Nonnull)offendingUser reportCategory:(enum SBDReportCategory)reportCategory reportDescription:(NSString * _Nullable)reportDescription completionHandler:(void (^ _Nullable)(SBError * _Nullable))completionHandler SWIFT_DEPRECATED_MSG("This method is deprecated in 4.23.0. Retrieve report categories from `getReportCategoryInfoList(completionHandler:)` and use `reportUser(_:reportCategoryInfo:reportDescription:completionHandler:)` instead.", "reportUser:reportCategoryInfo:reportDescription:completionHandler:");
...
/// \param completionHandler The handler block to execute.
///
- (void)reportChannelWithCategory:(enum SBDReportCategory)category reportDescription:(NSString * _Nullable)reportDescription completionHandler:(void (^ _Nullable)(SBError * _Nullable))completionHandler SWIFT_DEPRECATED_MSG("This method is deprecated in 4.23.0. Retrieve report categories from `getReportCategoryInfoList(completionHandler:)` and use `report(reportCategoryInfo:reportDescription:completionHandler:)` instead.", "reportChannelWithReportCategoryInfo:reportDescription:completionHandler:");
...
/// \param completionHandler The handler block to execute.
///
- (void)reportMessage:(SBDBaseMessage * _Nonnull)message reportCategory:(enum SBDReportCategory)reportCategory reportDescription:(NSString * _Nullable)reportDescription completionHandler:(void (^ _Nullable)(SBError * _Nullable))completionHandler SWIFT_DEPRECATED_MSG("This method is deprecated in 4.23.0. Retrieve report categories from `getReportCategoryInfoList(completionHandler:)` and use  `reportMessage(_:reportCategoryInfo:reportDescription:completionHandler:)` instead.", "reportMessage:reportCategoryInfo:reportDescription:completionHandler:");
/// Reports a user in a channel of inappropriate activities.
/// since:
/// 4.23.0
/// \param offendingUser The user who is being reported.
///
/// \param reportCategoryInfo The <code>ReportCategoryInfo</code> in which the report is being submitted. It can be retrieved from <code>SendbirdChat.getReportCategoryInfoList</code>.
///
/// \param reportDescription An open ended description for why the report is being submitted.
///
/// \param completionHandler The handler block to execute.
///
- (void)reportUser:(SBDUser * _Nonnull)offendingUser reportCategoryInfo:(SBDReportCategoryInfo * _Nonnull)reportCategoryInfo reportDescription:(NSString * _Nullable)reportDescription completionHandler:(void (^ _Nullable)(SBError * _Nullable))completionHandler;
/// Reports current channel instance of inappropriate activities.
/// since:
/// 4.23.0
/// \param reportCategoryInfo The <code>ReportCategoryInfo</code> in which the report is being submitted. It can be retrieved from <code>SendbirdChat.getReportCategoryInfoList</code>.
...
/// \param completionHandler The handler block to execute.
///
- (void)reportChannelWithReportCategoryInfo:(SBDReportCategoryInfo * _Nonnull)reportCategoryInfo reportDescription:(NSString * _Nullable)reportDescription completionHandler:(void (^ _Nullable)(SBError * _Nullable))completionHandler;
/// Reports a malicious message in the channel
/// since:
/// 4.23.0
/// \param message The message object which is being reported.
...
/// \param completionHandler The handler block to execute.
///
- (void)reportMessage:(SBDBaseMessage * _Nonnull)message reportCategoryInfo:(SBDReportCategoryInfo * _Nonnull)reportCategoryInfo reportDescription:(NSString * _Nullable)reportDescription completionHandler:(void (^ _Nullable)(SBError * _Nullable))completionHandler;
...
/// warning:
/// This method will always fail because it is an interface that is no longer supported
...
///
- (void)submitFormWithFormKey:(NSString * _Nonnull)formKey answers:(NSDictionary<NSString *, NSString *> * _Nonnull)answers completionHandler:(void (^ _Nullable)(SBError * _Nullable))completionHandler SWIFT_DEPRECATED_MSG("This method is deprecated in 4.14.1.", "submitMessageForm(form:completionHandler:)");
/// warning:
/// This method will always fail because it is an interface that is no longer supported
/// Submit data for a form type message.
/// A form type message contains <code>forms</code> fields in the message’s <code>extendedMessagePayload</code>.
...
/// \param completionHandler The handler block to be executed after the answer is submitted.
///
- (void)submitFormWithForm:(SBDForm * _Nonnull)form completionHandler:(void (^ _Nullable)(SBError * _Nullable))completionHandler SWIFT_DEPRECATED_MSG("This method is deprecated in 4.21.0.", "submitMessageForm(form:completionHandler:)");
/// Submit data for a form type message.
/// A form type message contains <code>form</code> fields in the message’s <code>extendedMessagePayload</code>.
/// The <code>BaseMessage/form</code> property is the instance that contains the form information.
/// Using the given <code>MessageForm</code> model,
/// You can do that just by updating the <code>FormItem/temporaryAnswer</code> property of each of the <code>fields</code>.
/// since:
/// 4.21.0
/// \param form A message form instance with the answer to submit updated in <code>FormField/temporaryAnswer</code>.
///
/// \param completionHandler The handler block to be executed after the answer is submitted.
///
- (void)submitMessageFormWithCompletionHandler:(void (^ _Nullable)(SBError * _Nullable))completionHandler;
@end
...
enum SBDCSATSubmitParamsResolutionStatus : NSInteger;

/// Parameters for submitting CSAT (Customer Satisfaction) survey results.
/// since:
/// 4.26.0
SWIFT_CLASS_NAMED("CSATSubmitParams")
@interface SBDCSATSubmitParam : NSObject
@property (nonatomic, copy) NSString * _Nonnull type;
@property (nonatomic) int64_t csat;
@property (nonatomic, copy) NSString * _Nullable csatReason;
@property (nonatomic) enum SBDCSATSubmitParamsResolutionStatus resolutionStatus;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


@interface SBDCSATSubmitParam (SWIFT_EXTENSION(SendbirdChatSDK))
@end

typedef SWIFT_ENUM_NAMED(NSInteger, SBDCSATSubmitParamsResolutionStatus, "ResolutionStatus", open) {
  SBDCSATSubmitParamsResolutionStatusUnresponsive = 0,
  SBDCSATSubmitParamsResolutionStatusPositive = 1,
  SBDCSATSubmitParamsResolutionStatusNegative = 2,
};
...
/// The <code>EventDetail</code> of current context. Includes detailed information which are provided as function parameters in <code>GroupChannelDelegate</code>.
/// since:
/// 4.21.0
@property (nonatomic, strong) SBDEventDetail * _Nonnull eventDetail;
...
typedef SWIFT_ENUM_NAMED(NSInteger, SBChatError, "ChatError", open) {
  ...
  SBChatErrorReconnectLoginTimeout = 800191,
...
/// Member marked all messages as read
/// since:
/// 4.28.0
  SBDCollectionEventSourceEventUserDidMarkAsRead = 137,
/// Member marked a message as unread
/// since:
/// 4.28.0
  SBDCollectionEventSourceEventUserDidMarkAsUnread = 138,
};
...
enum SBDConversationStatus : NSInteger;
@class SBDConverationChannelInfo;
@class SBDConversationResolution;
@class SBDConversationHandoff;

/// since:
/// 4.26.0
SWIFT_CLASS_NAMED("Conversation")
@interface SBDConversation : NSObject
/// The ID of the conversation
@property (nonatomic) int64_t id;
/// The status of the conversation
@property (nonatomic) enum SBDConversationStatus status;
/// The channel information of the conversation
@property (nonatomic, strong) SBDConverationChannelInfo * _Nonnull channelInfo;
/// The CSAT Type
@property (nonatomic, copy) NSString * _Nullable csatType;
/// The CSAT score of the conversation
@property (nonatomic) int64_t csat;
/// The reason for the CSAT score
@property (nonatomic, copy) NSString * _Nullable csatReason;
/// Value indicating when the CSAT submission ended
@property (nonatomic) int64_t csatExpireAt;
/// The CRE value the user responded
@property (nonatomic, strong) SBDConversationResolution * _Nullable resolution;
/// The topics of the conversation
@property (nonatomic, copy) NSArray<NSString *> * _Nullable topics;
/// The handoff detail of the conversation
@property (nonatomic, strong) SBDConversationHandoff * _Nullable handoff;
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// This class is used to store the information of the conversation channel.
/// since:
/// 4.26.0
SWIFT_CLASS_NAMED("ConversationChannelInfo")
@interface SBDConverationChannelInfo : NSObject
@property (nonatomic, copy) NSString * _Nonnull url;
@property (nonatomic) int64_t lastMessageTs;
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// Represents a conversation handoff object.
/// since:
/// 4.26.0
SWIFT_CLASS_NAMED("ConversationHandoff")
@interface SBDConversationHandoff : NSObject
@property (nonatomic, copy) NSString * _Nonnull type;
...
typedef SWIFT_ENUM_NAMED(NSInteger, SBDConversationListOrder, "ConversationListOrder", open) {
  SBDConversationListOrderUpdatedAt = 0,
  SBDConversationListOrderCreatedAt = 1,
};


SWIFT_CLASS_NAMED("ConversationListQuery")
@interface SBDConversationListQuery : NSObject <NSCopying>
@property (nonatomic) BOOL hasNext;
@property (nonatomic) BOOL isLoading;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("Use Conversation's `createConversationListQuery`");
/// Fetches next page
/// \param completionHandler completion handler
///
- (void)loadNextPageWithCompletionHandler:(void (^ _Nonnull)(NSArray<SBDConversation *> * _Nullable, SBError * _Nullable))completionHandler;
/// Copies this object
/// \param zone optional <code>NSZone</code>
///
///
/// returns:
/// <code>ConversationListQuery</code> instance
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS_NAMED("ConversationListQueryParams")
@interface SBDConversationListQueryParams : NSObject
/// since:
/// 4.26.0
@property (nonatomic, copy) NSString * _Nonnull aiAgentId;
/// since:
/// 4.26.0
@property (nonatomic) enum SBDConversationStatus status;
/// since:
...
/// since:
/// 4.26.0
@property (nonatomic) enum SBDConversationListOrder order;
/// Default constructor.
/// since:
/// 4.26.0
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
/// returns:
/// An initialized params object.
- (nonnull instancetype)initWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDConversationListQueryParams * _Nonnull))builder OBJC_DESIGNATED_INITIALIZER;
@end


@interface SBDConversationListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end


@interface SBDConversationListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK)) <NSCopying>
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
@end


/// Represents the resolution status of a conversation.
/// since:
/// 4.26.0
SWIFT_CLASS_NAMED("ConversationResolution")
@interface SBDConversationResolution : NSObject
@property (nonatomic) BOOL isResolved;
@property (nonatomic, copy) NSString * _Nonnull determinedBy;
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// since:
/// 4.26.0
typedef SWIFT_ENUM_NAMED(NSInteger, SBDConversationStatus, "ConversationStatus", open) {
  SBDConversationStatusOpen = 0,
  SBDConversationStatusClosed = 1,
};
...
typedef SWIFT_ENUM_NAMED(NSInteger, SBCoreError, "CoreError", open) {
  ...
  SBCoreErrorFileUploadTimeoutByNetwork = 800251,
...
SWIFT_CLASS_NAMED("CustomHosts")
@interface SBDCustomHosts : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
/// since:
/// 4.27.0
typedef SWIFT_ENUM_NAMED(NSInteger, SBDDeskChannelFilter, "DeskChannelFilter", open) {
  SBDDeskChannelFilterExclude = 0,
  SBDDeskChannelFilterInclude = 1,
};
...
/// General class for representing event details for <code>ChannelContext</code> and <code>FeedChannelContext</code>.
/// Every detail from delegate functions from <code>GroupChannelDelegate</code> and <code>FeedChannelDelegate</code> can be found as a subclass of <code>EventDetail</code>
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("EventDetail")
@interface SBDEventDetail : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("ChannelChangelogs")
@interface SBDChannelChangelogs : SBDEventDetail
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("ChannelRefresh")
@interface SBDChannelRefresh : SBDEventDetail
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channelWasChanged(_:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("ChannelChanged")
@interface SBDChannelChanged : SBDEventDetail
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channelDidChangeMemberCount(_:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("ChannelMemberCountChanged")
@interface SBDChannelMemberCountChanged : SBDEventDetail
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channelWasFrozen(_:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("ChannelFrozen")
@interface SBDChannelFrozen : SBDEventDetail
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channelWasUnfrozen(_:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("ChannelUnfrozen")
@interface SBDChannelUnfrozen : SBDEventDetail
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channelWasHidden(_:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("ChannelHidden")
@interface SBDChannelHidden : SBDEventDetail
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channelWasDeleted(_:channelType:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("ChannelDeleted")
@interface SBDChannelDeleted : SBDEventDetail
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channelDidUpdateOperators(_:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("OperatorUpdated")
@interface SBDOperatorUpdated : SBDEventDetail
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channelDidUpdateTypingStatus(_:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("TypingStatusUpdated")
@interface SBDTypingStatusUpdated : SBDEventDetail
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channelDidUpdateDeliveryStatus(_:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("DeliveryStatusUpdated")
@interface SBDDeliveryStatusUpdated : SBDEventDetail
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channelDidUpdateReadStatus(_:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("ReadStatusUpdated")
@interface SBDReadStatusUpdated : SBDEventDetail
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channelDidMarkAsRead(_:userIds:)</code>.
/// since:
/// 4.28.0
SWIFT_CLASS_NAMED("UserDidMarkAsRead")
@interface SBDDidMarkAsRead : SBDEventDetail
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channelDidMarkAsUnread(_:userIds:)</code>.
/// since:
/// 4.28.0
SWIFT_CLASS_NAMED("UserDidMarkAsUnread")
@interface SBDDidMarkAsUnread : SBDEventDetail
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channelDidUpdatePinnedMessages(_:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("PinnedMessageUpdated")
@interface SBDPinnedMessageUpdated : SBDEventDetail
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channel(_:didUpdateFeedbackMessage:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("UpdateFeedbackMessage")
@interface SBDUpdateFeedbackMessage : SBDEventDetail
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channel(_:didReceiveMention:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("MentionReceived")
@interface SBDMentionReceived : SBDEventDetail
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channel(_:userWasMuted:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("UserMuted")
@interface SBDUserMuted : SBDEventDetail
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channel(_:userWasUnmuted:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("UserUnmuted")
@interface SBDUserUnmuted : SBDEventDetail
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channel(_:userWasBanned:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("UserBanned")
@interface SBDUserBanned : SBDEventDetail
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


/// Represents the event source detail for<code>GroupChannelDelegate.channel(_:userWasUnbanned:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("UserUnbanned")
@interface SBDUserUnbanned : SBDEventDetail
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channel(_:createdMetaData:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("MetaDataCreated")
@interface SBDMetaDataCreated : SBDEventDetail
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channel(_:updatedMetaData:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("MetaDataUpdated")
@interface SBDMetaDataUpdated : SBDEventDetail
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channel(_:deletedMetaDataKeys:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("MetaDataDeleted")
@interface SBDMetaDataDeleted : SBDEventDetail
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channel(_:createdMetaCounters:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("MetaCountersCreated")
@interface SBDMetaCountersCreated : SBDEventDetail
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channel(_:updatedMetaCounters:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("MetaCountersUpdated")
@interface SBDMetaCountersUpdated : SBDEventDetail
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channel(_:deletedMetaCountersKeys:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("MetaCountersDeleted")
@interface SBDMetaCountersDeleted : SBDEventDetail
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channel(_:didReceiveInvitation:inviter:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("UserReceivedInvitation")
@interface SBDUserReceivedInvitation : SBDEventDetail
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channel(_:didDeclineInvitation:inviter:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("UserDeclinedInvitation")
@interface SBDUserDeclinedInvitation : SBDEventDetail
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channel(_:userDidJoin:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("UserJoined")
@interface SBDUserJoined : SBDEventDetail
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


/// Represents the event source detail for <code>GroupChannelDelegate.channel(_:userDidLeave:)</code>.
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("UserLeft")
@interface SBDUserLeft : SBDEventDetail
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// Event source
@property (nonatomic) enum SBDCollectionEventSource source;
/// The <code>EventDetail</code> of current context. Includes detailed information which are provided as function parameters in <code>FeedChannelDelegate</code>.
/// since:
/// 4.21.0
@property (nonatomic, strong) SBDEventDetail * _Nonnull eventDetail;
/// Checks whether the context is from an event or not.
...
/// since:
/// 4.14.1
SWIFT_CLASS_NAMED("Form") SWIFT_DEPRECATED_MSG("This method is deprecated in 4.21.0", "SBDMessageForm")
...
/// since:
/// 4.14.1
SWIFT_CLASS_NAMED("FormField") SWIFT_DEPRECATED_MSG("This method is deprecated in 4.21.0", "SBDMessageFormItem")
...
/// Field to store the data to be submitted.
...
/// since:
/// 4.14.1
SWIFT_CLASS_NAMED("FormFieldAnswer") SWIFT_DEPRECATED_MSG("This method is deprecated in 4.21.0")
...
SWIFT_PROTOCOL_NAMED("FormFieldValidator")
@protocol SBDFormFieldValidator
@property (nonatomic, readonly, copy) NSString * _Nonnull key;
- (BOOL)isValidWithInput:(NSString * _Nullable)input SWIFT_WARN_UNUSED_RESULT;
@end
...
@property (nonatomic, readonly, strong) SBDBaseMessage * _Nullable lastMessage;
...
/// since:
/// 4.27.0
@property (nonatomic, readonly) BOOL isAIAgent;
/// since:
/// 4.27.0
@property (nonatomic, readonly) BOOL isDesk;
...
/// Offset of hard-deleted message of a channel.
/// since:
/// 4.25.0
@property (nonatomic, readonly) int64_t messageDeletionTimestamp;
...
/// since:
/// 4.20.0
@property (nonatomic) BOOL hasAIBot;
/// Indicates whether this channel includes any bots.
/// since:
/// 4.20.0
@property (nonatomic) BOOL hasBot;
/// The conversation payload of this channel
/// since:
/// 4.26.0
@property (nonatomic, strong) SBDConversation * _Nullable conversation;
...
///
- (void)markAsReadWithCompletionHandler:(void (^ _Nullable)(SBError * _Nullable))completionHandler;
/// Marks a message as unread. Messages that came later than the marked message will also become unread.
/// Other members in the group channel will receive<code>channelDidUpdateReadStatus:</code>  in <code>GroupChannelDelegate</code>.
/// Current user will receive <code>channelWasChanged(_:)</code> in <code>GroupChannelDelegate</code>.
/// since:
/// 4.27.0
...
/// \param completionHandler completion handler
///
- (void)markAsUnreadWithMessage:(SBDBaseMessage * _Nonnull)message completionHandler:(void (^ _Nullable)(SBError * _Nullable))completionHandler;
...
/// Retrieves messageDeletionTimestamp value.
/// since:
/// 4.25.0
/// \param completionHandler The handler block to execute.
///
- (void)getMessageDeletionTimestampWithCompletionHandler:(void (^ _Nullable)(int64_t, SBError * _Nullable))completionHandler;
/// Submit satisfaction scores for conversations with the AI Agent.
/// since:
/// 4.26.0
/// <ul>
///   <li>
...
///   </li>
///   <li>
///     params: The params to submit the CSAT.
///   </li>
///   <li>
///     completionHandler: The handler to be invoked when the operation completes.
///   </li>
/// </ul>
- (void)submitCSATWithParams:(SBDCSATSubmitParam * _Nonnull)params completionHandler:(void (^ _Nullable)(SBDGroupChannel * _Nullable, SBError * _Nullable))completionHandler;
/// This is used when a transfer from an AI agent to a human agent is required.
/// since:
/// 4.26.0
/// \param completionHandler The handler to be invoked when the operation completes.
///
- (void)markConversationAsHandoffWithCompletionHandler:(void (^ _Nullable)(SBDGroupChannel * _Nullable, SBError * _Nullable))completionHandler;
/// Closes the current AI Agent conversation.
/// This method is intended for internal use only. External modules should not call this directly,
/// as it is part of the internal SPI (<code>SendbirdInternal</code>) and may change without notice.
/// since:
/// 4.26.0
/// \param completionHandler The closure to execute when the close operation finishes. Provides the updated channel on success, or an error on failure.
///
- (void)closeConversationWithCompletionHandler:(void (^ _Nullable)(SBDGroupChannel * _Nullable, SBError * _Nullable))completionHandler;
/// Retrieves the context object for an AI agent
/// since:
/// 4.29.0
/// \param aiAgentId The unique identifier of the AI agent
///
/// \param completionHandler The completion handler to call when the operation is complete
///
- (void)getContextObjectWithAiAgentId:(NSString * _Nonnull)aiAgentId completionHandler:(void (^ _Nullable)(RawResponse * _Nullable, SBError * _Nullable))completionHandler;
/// Replaces the entire context data for an AI agent (PUT operation)
/// note:
/// This will completely replace the existing context data
/// since:
/// 4.29.0
/// \param aiAgentId The unique identifier of the AI agent
///
/// \param params The parameters containing context data to update
///
/// \param completionHandler The completion handler to call when the operation is complete
///
- (void)updateContext:(NSDictionary<NSString *, NSString *> * _Nonnull)context aiAgentId:(NSString * _Nonnull)aiAgentId completionHandler:(void (^ _Nullable)(RawResponse * _Nullable, SBError * _Nullable))completionHandler;
/// Merges new context data with existing context data for an AI agent (PATCH operation)
/// note:
/// This will merge with existing context data, adding new keys and updating existing ones
/// since:
/// 4.29.0
/// \param aiAgentId The unique identifier of the AI agent
///
...
/// \param completionHandler The completion handler to call when the operation is complete
///
- (void)patchContext:(NSDictionary<NSString *, NSString *> * _Nonnull)context aiAgentId:(NSString * _Nonnull)aiAgentId completionHandler:(void (^ _Nullable)(RawResponse * _Nullable, SBError * _Nullable))completionHandler;
@end
...
/// \param channel The group channel.
///
/// \param message Translated Message object.
///
- (void)channel:(SBDBaseChannel * _Nonnull)channel didTranslate:(SBDUserMessage * _Nonnull)message;
/// Invoked when channel’s messageOffset (either messageOffsetTimestamp or messageDeletionTimestamp) is updated.
/// since:
/// 4.24.2
/// \param channel The group channel.
///
/// \param didUpdateMessageOffset Updated result.
///
/// \param lastMessageReset A flag indicating whether the last message has been reset due to the change in the messageOffset.max().
///
- (void)channel:(SBDBaseChannel * _Nonnull)channel didUpdateMessageOffset:(enum MergeResult)result lastMessageReset:(BOOL)lastMessageReset;
@end
...
///
- (void)channelDidUpdateReadStatus:(SBDGroupChannel * _Nonnull)channel SWIFT_DEPRECATED_MSG("This method is deprecated in 4.27.0. Use `channelDidUpdateReadStatus(_:userIds:)` instead.", "channelDidUpdateReadStatus:userIds:");
/// A callback when read status updated by any member of the channel (including the current user).
/// since:
/// 4.27.0
/// \param channel The group channel where the read status was updated.
///
/// \param userIds The userIds of the users who triggered the read status event.
///
- (void)channelDidUpdateReadStatus:(SBDGroupChannel * _Nonnull)channel userIds:(NSArray<NSString *> * _Nonnull)userIds SWIFT_DEPRECATED_MSG("This method is deprecated in 4.28.0. Use `channelDidMarkAsRead(_:userIds:)` or `channelDidMarkAsUnread(_:userIds:)` instead.");
/// A callback that is called when a member marks channel as read (including the current user).
/// since:
/// 4.28.0
/// \param channel The group channel where the read status was updated.
///
/// \param userIds The userIds of the users who triggered the read event.
///
- (void)channel:(SBDGroupChannel * _Nonnull)channel userDidMarkAsRead:(NSArray<NSString *> * _Nonnull)userIds;
/// A callback that is called when a member marks a message as unread (including the current user).
/// since:
/// 4.28.0
/// \param channel The group channel where the read status was updated.
///
/// \param userIds The userIds of the users who triggered the unread event.
///
- (void)channel:(SBDGroupChannel * _Nonnull)channel userDidMarkAsUnread:(NSArray<NSString *> * _Nonnull)userIds;
...
/// since:
/// 4.27.0
- (void)channelDidUpdateReadStatus:(SBDGroupChannel * _Nonnull)channel userIds:(NSArray<NSString *> * _Nonnull)userIds;
/// since:
/// 4.28.0
- (void)channel:(SBDGroupChannel * _Nonnull)channel userDidMarkAsRead:(NSArray<NSString *> * _Nonnull)userIds;
/// since:
...
- (void)channel:(SBDBaseChannel * _Nonnull)channel deletedMetaCountersKeys:(NSArray<NSString *> * _Nullable)deletedMetaCountersKeys;
- (void)channelDidUpdatePinnedMessages:(SBDGroupChannel * _Nonnull)channel;
- (void)channel:(SBDGroupChannel * _Nonnull)channel didUpdateFeedbackMessage:(SBDBaseMessage * _Nonnull)message;
@end
...
@interface AIAgentGroupChannelListQuery (SWIFT_EXTENSION(SendbirdChatSDK)) <Serializable>
/// Serializes this object into data
///
/// returns:
/// optioanal <code>Data</code> instance
...
///
/// returns:
/// <code>AIAgent.GroupChannelListQuery</code> if parameter is valid, otherwise <code>nil</code>
+ (nullable instancetype)buildFromSerializedData:(NSData * _Nullable)data SWIFT_WARN_UNUSED_RESULT;
@end


@interface AIAgentGroupChannelListQuery (SWIFT_EXTENSION(SendbirdChatSDK))
/// Copies this object
/// \param zone optional <code>NSZone</code>
///
///
/// returns:
/// <code>AIAgent.GroupChannelListQuery</code> instance
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
/// Validates the given channel object is belonged to this query object
/// \param channel a group channel
///
...
@interface AIAgentGroupChannelListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end


@interface AIAgentGroupChannelListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK)) <NSCopying>
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
@end
...
/// since:
/// 4.21.0
SWIFT_CLASS_NAMED("GroupChannelUnreadItemCountParams")
@interface SBDGroupChannelUnreadItemCountParams : NSObject
/// The optionSets to contain count flags.
@property (nonatomic, strong) SBDUnreadItemKey * _Nonnull key;
/// The string array of custom type filter.
@property (nonatomic, copy) NSArray<NSString *> * _Nullable customTypesFilter;
- (nonnull instancetype)initWithKey:(SBDUnreadItemKey * _Nonnull)key customTypesFilter:(NSArray<NSString *> * _Nullable)customTypesFilter OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// \param appVersion host app version
///
/// \param apiHost If you have an apiHost to customize, you can set it in the Settings
///
/// \param wsHost If you have an wsHost to customize, you can set it in the Settings
///
/// \param needsSynchronous If this value set <code>true</code>, when SendbirdChat is initialized, the work thread will be handled synchronously until the localCaching migration is complete.
///
- (nonnull instancetype)initWithApplicationId:(NSString * _Nonnull)applicationId isLocalCachingEnabled:(BOOL)isLocalCachingEnabled localCacheConfig:(SBDLocalCacheConfig * _Nullable)localCacheConfig logLevel:(enum SBDLogLevel)logLevel appVersion:(NSString * _Nullable)appVersion apiHost:(NSString * _Nullable)apiHost wsHost:(NSString * _Nullable)wsHost needsSynchronous:(BOOL)needsSynchronous OBJC_DESIGNATED_INITIALIZER;
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface SBDLocalCacheConfig : NSObject <NSCopying>
...
/// Message collection delegate.
@property (nonatomic, readonly) int64_t startingPoint;
...
/// \param collection Message collection object.
///
/// \param channelContext The reason why the channel are changed.
///
/// \param updatedChannel The channel that has the message collection has.
///
- (void)messageCollection:(SBDMessageCollection * _Nonnull)collection channelContext:(SBDChannelContext * _Nonnull)channelContext updatedChannel:(SBDGroupChannel * _Nonnull)updatedChannel;
...
///
- (void)messageCollection:(SBDMessageCollection * _Nonnull)collection channelContext:(SBDChannelContext * _Nonnull)channelContext deletedChannel:(NSString * _Nonnull)channelURL;
...
/// \param updatedChannel The channel that has the message collection has.
///
- (void)messageCollection:(SBDMessageCollection * _Nonnull)collection context:(SBDMessageContext * _Nonnull)context updatedChannel:(SBDGroupChannel * _Nonnull)updatedChannel SWIFT_DEPRECATED_MSG("This method is deprecated in 4.23.2. Use `messageCollection(_:channelContext:updatedChannel:)` instead. If this delegate method and `messageCollection(_:channelContext:updatedChannel:)` delegate method are implemented together, each delegate will receive the same event, so use only one.", "messageCollection:channelContext:updatedChannel:");
/// Invoked when the channel that has the message collection is deleted.
/// \param collection Message collection object.
///
/// \param context The reason why the channel are deleted.
...
/// \param channelURL Channel URL that has been deleted.
///
- (void)messageCollection:(SBDMessageCollection * _Nonnull)collection context:(SBDMessageContext * _Nonnull)context deletedChannel:(NSString * _Nonnull)channelURL SWIFT_DEPRECATED_MSG("This method is deprecated in 4.23.2. Use `messageCollection(_:channelContext:deletedChannel:)` instead. If this delegate method and `messageCollection(_:channelContext:deletedChannel:)` delegate method are implemented together, each delegate will receive the same event, so use only one.", "messageCollection:channelContext:deletedChannel:");
@end
...
/// Message form data
/// Since: 4.21.0
SWIFT_CLASS_NAMED("MessageForm")
@interface SBDMessageForm : NSObject <NSCopying>
/// Copies this object
/// \param zone optional <code>NSZone</code>
///
///
...
@interface SBDMessageForm (SWIFT_EXTENSION(SendbirdChatSDK))
/// Indicates that the form data has already been submitted.
@property (nonatomic, readonly) BOOL isSubmitted;
/// Indicates that the form data can be submitted.
///
...
/// The item data held by the Message form.
/// Since: 4.21.0
SWIFT_CLASS_NAMED("MessageFormItem")
@interface SBDMessageFormItem : NSObject <NSCopying>
/// Copies this object
/// \param zone optional <code>NSZone</code>
///
///
...
- (BOOL)isValid:(NSArray<NSString *> * _Nullable)draftValues SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface SBDMessageFormItem (SWIFT_EXTENSION(SendbirdChatSDK))
@end
...
@interface SBDMessageFormItemStyle : NSObject <NSCopying>
/// Copies this object
/// \param zone optional <code>NSZone</code>
///
///
...
/// since:
/// 4.21.0
typedef SWIFT_ENUM_NAMED(NSInteger, SBDMessageFormItemLayoutType, "LayoutType", open) {
  SBDMessageFormItemLayoutTypeText = 0,
  SBDMessageFormItemLayoutTypeTextarea = 1,
  SBDMessageFormItemLayoutTypeNumber = 2,
  SBDMessageFormItemLayoutTypePhone = 3,
  SBDMessageFormItemLayoutTypeEmail = 4,
  SBDMessageFormItemLayoutTypeChip = 5,
  SBDMessageFormItemLayoutTypeUnknown = 6,
};


/// Data to limit the number of values entered
/// Since: 4.21.0
SWIFT_CLASS_NAMED("ResultCount")
@interface SBDMessageFormItemResultCount : NSObject <NSCopying>
/// Copies this object
/// \param zone optional <code>NSZone</code>
///
///
...
/// The number of messages to retrieve that were sent before the specified timestamp or message ID. Default is 40
...
@interface AIAgentMessageTemplateListParams (SWIFT_EXTENSION(SendbirdChatSDK))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end


@interface AIAgentMessageTemplateListParams (SWIFT_EXTENSION(SendbirdChatSDK)) <NSCopying>
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
@end
...
/// \param channel The open channel.
///
- (void)channelDidUpdatePinnedMessages:(SBDOpenChannel * _Nonnull)channel;
@end
...
/// 3.0.216
@property (nonatomic, readonly) BOOL includeMetaData;
/// Whether the result channel includes pinned messages. Default is <code>true</code>
/// since:
/// 4.20.0
@property (nonatomic, readonly) BOOL includePinnedMessages;
...
/// since:
/// 4.20.0
@property (nonatomic) BOOL includePinnedMessages;
/// Sets the channel URL filter.
...
/// A simple wrapper class for holding raw JSON payload as a string.
/// This is typically used to preserve the exact JSON response structure
/// without decoding it into a model object. Useful for logging, debugging,
/// or deferred parsing scenarios.
/// since:
/// 4.26.0
SWIFT_CLASS("_TtC15SendbirdChatSDK11RawResponse")
...
/// An object that represents the information of the user who reacted to a message.
/// since:
/// 4.24.0
SWIFT_CLASS_NAMED("ReactedUserInfo")
@interface SBDReactedUserInfo : NSObject
/// User ID
@property (nonatomic, readonly, copy) NSString * _Nonnull userId;
/// User nickname.
...
@property (nonatomic, readonly, copy) NSString * _Nullable profileURL;
/// The profile image URL without the <code>ekey</code>.
@property (nonatomic, readonly, copy) NSString * _Nullable plainProfileImageURL;
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// A list of sampled <code>ReactedUserInfo</code> that have reacted to this Reaction.
/// since:
/// 4.24.0
@property (nonatomic, readonly, copy) NSArray<SBDReactedUserInfo *> * _Nonnull sampledUserInfoList;
...
/// User
@property (nonatomic, readonly, strong) SBDUser * _Nullable reader;
/// Read timestamp
@property (nonatomic, readonly) int64_t timestamp;
@property (nonatomic, readonly, copy) NSString * _Nullable channelUrl SWIFT_UNAVAILABLE_MSG("'channelUrl' has been renamed to 'channelURL'");
/// Channel URL
@property (nonatomic, readonly, copy) NSString * _Nullable channelURL;
/// Channel type
@property (nonatomic, readonly, copy) NSString * _Nullable channelType;
/// Request ID for checking ACK.
@property (nonatomic, readonly, copy) NSString * _Nullable reqId;
...
/// Category for reporting a channel, message, or user.
/// since:
/// 4.23.0
SWIFT_CLASS_NAMED("ReportCategoryInfo")
@interface SBDReportCategoryInfo : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// returns:
/// <code>SBError</code> object.
+ (SBError * _Nonnull)errorWithNSError:(NSError * _Nonnull)error SWIFT_WARN_UNUSED_RESULT;
/// Create error object
/// \param domain domain.
///
...
/// Authenticate with the Sendbird server. Calling this method will grant you access to Sendbird Business Messaging’s features. If you want to access Sendbird Chat’s features, call <code>SendbirdChat.connect</code>. You can deauthenticate from the Sendbird server by calling <code>SendbirdChat.disconnect</code>.
/// note:
...
/// \param completionHandler The handler block to execute. <code>user</code> is the object to represent the current user.
///
+ (void)authenticateFeedWithUserId:(NSString * _Nonnull)userId authToken:(NSString * _Nullable)authToken completionHandler:(void (^ _Nullable)(SBDUser * _Nullable, SBError * _Nullable))completionHandler SWIFT_DEPRECATED_MSG("", "authenticate");
/// Authenticate with the Sendbird server. Calling this method will grant you access to Sendbird Business Messaging’s features. If you want to access Sendbird Chat’s features, call <code>SendbirdChat.connect</code>. You can deauthenticate from the Sendbird server by calling <code>SendbirdChat.disconnect</code>.
/// note:
/// Use the <code>disconnect(completionHandler:)</code> method to deauthenticate.
/// since:
...
/// \param completionHandler The handler block to execute. <code>user</code> is the object to represent the current user.
///
+ (void)authenticateFeedWithUserId:(NSString * _Nonnull)userId authToken:(NSString * _Nullable)authToken apiHost:(NSString * _Nullable)apiHost completionHandler:(void (^ _Nullable)(SBDUser * _Nullable, SBError * _Nullable))completionHandler SWIFT_DEPRECATED_MSG("", "authenticateWithUserId:authToken:apiHost:completionHandler:");
/// Authenticate with the Sendbird server. Calling this method will grant you access to Sendbird Business Messaging’s features. If you want to access Sendbird Chat’s features, call <code>SendbirdChat.connect</code>. You can deauthenticate from the Sendbird server by calling <code>SendbirdChat.disconnect</code>.
/// note:
/// Use the <code>disconnect(completionHandler:)</code> method to deauthenticate.
/// since:
...
/// \param userId The user ID.
///
/// \param authToken The session token. If the user doesn’t have session token, set nil. If the user uses access token, use <code>authenticate(userId:authToken:authTokenType:apiHost:completionHandler:)</code> with <code>authTokenType</code> set to <code>.accessToken</code>.
///
/// \param apiHost apiHost
///
/// \param completionHandler The handler block to execute. <code>user</code> is the object to represent the current user.
///
+ (void)authenticateWithUserId:(NSString * _Nonnull)userId authToken:(NSString * _Nullable)authToken apiHost:(NSString * _Nullable)apiHost completionHandler:(void (^ _Nullable)(SBDUser * _Nullable, SBError * _Nullable))completionHandler;
/// Authenticate with the Sendbird server. Calling this method will grant you access to Sendbird Business Messaging’s features. If you want to access Sendbird Chat’s features, call <code>SendbirdChat.connect</code>. You can deauthenticate from the Sendbird server by calling <code>SendbirdChat.disconnect</code>.
/// note:
/// Use the <code>disconnect(completionHandler:)</code> method to deauthenticate.
/// since:
...
/// \param completionHandler The handler block to execute. <code>user</code> is the object to represent the current user.
///
+ (void)authenticateWithUserId:(NSString * _Nonnull)userId authToken:(NSString * _Nullable)authToken authTokenType:(enum SBDAuthTokenType)authTokenType apiHost:(NSString * _Nullable)apiHost completionHandler:(void (^ _Nullable)(SBDUser * _Nullable, SBError * _Nullable))completionHandler;
...
/// 4.19.8
/// \param completionHandler The handler block to execute. The <code>unreadCount</code> is the
/// total count of unread notifications in all of feed channel which the current is a member of..
///
+ (void)getTotalUnreadNotificationsCountWithCompletionHandler:(void (^ _Nonnull)(NSUInteger, SBError * _Nullable))completionHandler;
...
/// wrong to response.
///
+ (void)getUnreadItemCountWithKey:(SBDUnreadItemKey * _Nonnull)key completionHandler:(void (^ _Nonnull)(SBDUnreadItemCount * _Nullable, SBError * _Nullable))completionHandler SWIFT_DEPRECATED_MSG("This method is deprecated in 4.21.0. Set `key` in `GroupChannelUnreadItemCountParams` and use `getUnreadItemCount(params:completionHandler:)` instead.", "getUnreadItemCountWithParams:completionHandler:");
/// Gets unread messages and mentions counts of message and invitation counts in super and non_super channels.
/// since:
/// 4.21.0
/// \param params <code>GroupChannelUnreadItemCountParams</code> object
///
/// \param completionHandler The handler block to be executed after getting unread item count.
/// This block has no return value and takes two argument. the one is type of <code>UnreadItemCount</code> that
/// contains unsinged interger for count you requested. The other is an error made when there is something
/// wrong to response.
///
+ (void)getUnreadItemCountWithParams:(SBDGroupChannelUnreadItemCountParams * _Nonnull)params completionHandler:(void (^ _Nonnull)(SBDUnreadItemCount * _Nullable, SBError * _Nullable))completionHandler;
...
/// since:
/// 4.19.8
/// \param apiHost The API host. If nil, the default host is used.
///
/// \param remoteNotificationPayload The remote notification payload
///
/// \param completionHandler The handler block to execute
///
+ (void)markPushNotificationAsDeliveredWithApiHost:(NSString * _Nullable)apiHost remoteNotificationPayload:(NSDictionary * _Nonnull)remoteNotificationPayload completionHandler:(void (^ _Nullable)(SBError * _Nullable))completionHandler;
/// Marks push notification as clicked for push tracking purpose only.
/// This does not mark the message as delivered.
/// since:
/// 4.18.0
/// \param remoteNotificationPayload The remote notification payload
...
/// \param completionHandler The handler block to execute
///
+ (void)markPushNotificationAsClickedWithRemoteNotificationPayload:(NSDictionary * _Nonnull)remoteNotificationPayload completionHandler:(void (^ _Nullable)(SBError * _Nullable))completionHandler;
/// Marks push notification as clicked for push tracking purpose only.
/// This does not mark the message as delivered.
/// since:
/// 4.19.8
...
/// \param completionHandler The handler block to execute
///
+ (void)markPushNotificationAsClickedWithApiHost:(NSString * _Nullable)apiHost remoteNotificationPayload:(NSDictionary * _Nonnull)remoteNotificationPayload completionHandler:(void (^ _Nullable)(SBError * _Nullable))completionHandler;
...
/// Loads the list of <code>ReportCategoryInfo</code>.
/// since:
/// 4.23.0
/// \param completionHandler The handler with the list of <code>ReportCategoryInfo</code>.
///
+ (void)getReportCategoryInfoListWithCompletionHandler:(void (^ _Nullable)(NSArray<SBDReportCategoryInfo *> * _Nullable, SBError * _Nullable))completionHandler;
...
/// Methods to request aiagent messenger setting information
/// since:
/// 4.26.0
/// \param params manual, auto paramater instances
///
/// \param completionHandler Handler to return the Widget Setting information.
///
+ (void)requestAIAgentMessengerSettingsWithParams:(SBDAIAgentMessengerSettingsParams * _Nonnull)params completionHandler:(void (^ _Nonnull)(RawResponse * _Nullable, SBError * _Nullable))completionHandler;
/// Creates a query for my conversation list.
/// since:
/// 4.26.0
/// \param params <code>ConversationListQueryParams</code>
...
/// returns:
/// GroupChannelListQuery instance for the current user.
+ (SBDConversationListQuery * _Nonnull)createConversationListQueryWithParams:(SBDConversationListQueryParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("This method is deprecated in 4.29.0. Please use `AIAgent.createConversationListQuery(params:)`");
/// Retrieves a list of AI agent message templates.
/// This method fetches the list of message templates associated with a specific AI Agent,
/// using the given parameters.
/// since:
...
/// retrieval, delivered as an <code>AIAgent.MessageTemplatesResultHandler</code>.
///
+ (void)getAIAgentMessageTemplateListWithParams:(AIAgentMessageTemplateListParams * _Nonnull)params completionHandler:(void (^ _Nonnull)(AIAgentMessageTemplateResult * _Nullable, SBError * _Nullable))completionHandler SWIFT_DEPRECATED_MSG("This method is deprecated in 4.29.0. Please use `AIAgent.getAIAgentMessageTemplateList(params:completionHandler:)`");
@end
...
///
+ (void)__addExtension:(NSString * _Nonnull)key version:(NSString * _Nonnull)version SWIFT_DEPRECATED_MSG("This method is deprecated in 4.25.8", "__addSendbirdExtensions(extensions:customData:)");
/// Used to set the version information of the Sendbird SDK extension.
/// \param key Extension sdk’s hidden key
///
/// \param version Extension sdk’s version string
...
SWIFT_CLASS("_TtC15SendbirdChatSDK22SessionWebSocketEngine")
...
SWIFT_CLASS("_TtC15SendbirdChatSDK13TaskOperation")
